...
export default async function BoutiquePage({
  ...
  const { products, total, totalPages } = await getProducts({
    ...
    enPromo: params.promo === "1",
    isNew: params.nouveau === "1",
    ...
    noteMini: params.note ? Number(params.note) : undefined,
    isBio: params.bio === "1",
    isVegan: params.vegan === "1",
    isSansParfum: params["sans-parfum"] === "1",
    isSansParabene: params["sans-parabene"] === "1",
    isCertifie: params.certifie === "1",
    page: currentPage,
    pageSize,
  });
