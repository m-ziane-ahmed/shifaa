...
export function FaqChatbot() {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed bottom-36 right-4 z-[45] flex h-[min(540px,75vh)] w-[min(380px,calc(100vw-2rem))] flex-col overflow-hidden rounded-2xl border border-shifaa-border bg-white shadow-lift md:bottom-24"
          role="dialog"
